...
// making the car  
car=createSprite(200,540,100,100);
car.addImage(carimg);
car.scale=0.6;
...
//making the track image
  image(trimg,-500,660,displayWidth*20,60);
...
if(frameCount%200===0){
  z=createSprite(car.x+800,550,10,10);
...
function bullet(){
  if(  touches.length > 0 || keyDown(UP_ARROW)){
    ...
    t=createSprite(car.x+200,425,10,10);
...
if(frameCount%250===0){
  gar=createSprite(car.x+280,650,10,10);
  gar.scale=0.3;
  var rand = Math.round(random(1,3));
  switch(rand){
